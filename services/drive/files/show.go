...
// will ignore the URL parameter and tries to find a file with the given ID.
// As a side-effect, if both of them are defined, but the FileID is different
// than the URL, but both exists, it will return the File with the given ID
// and ignores the URL parameter.
